...
\begin{frame}{Pour aller plus loin}
    \begin{block}{Chapitres suivants}
        \begin{itemize}
            \item \textbf{Chapitre 3} : Maximum de vraisemblance (théorie et propriétés)
            \item \textbf{Chapitre 4} : Algorithmes d'optimisation
            \item \textbf{Chapitre 5} : Modèles Logit et Probit en détail
            \item \textbf{Chapitre 6} : Variables polytomiques
            \item \textbf{Chapitres 7-11} : Extensions (comptage, durée, censure, équations multiples)
        \end{itemize}
    \end{block}
    ...
    \begin{block}{Références}
        \begin{itemize}
            ...
            \item Heckman, J.J. (1979). Sample selection bias as a specification error
        \end{itemize}
    \end{block}
\end{frame}
